extends Area2D
@export var item_scene: PackedScene = preload("res://Prefabs/pista_3.tscn") # Certifique-se de que esta cena é o seu NinePatchRect com Label
...
var dialog_data2: Dictionary = {
	0: {
		...
		"dialog": "Nossa parece que você foi esquecido aqui hein!!!",
		"title": "Elias"
	},
}

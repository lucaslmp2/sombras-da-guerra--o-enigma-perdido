extends Area2D
@export var item_scene: PackedScene = preload("res://Prefabs/jaleco.tscn")
...
var dialog_data: Dictionary = {
	0: {
		...
		"dialog": "É! ok! Acho que tá acabando.",
		"title": "Elias"
	},
	1: {
		"faceset": "res://Assets/Prontos/elias_face_asset_realista.png",
		"dialog": "Eram cinco peças, já é a penultima.",
		"title": "Elias"
	},
}
...
func spawn_item():
	if item_scene:
		...
		if item_instance is Area2D:
			...
			item_instance.connect("capuz_coletado", Callable(get_parent().get_parent(), "_on_disfarce_coletado"))
		else:
